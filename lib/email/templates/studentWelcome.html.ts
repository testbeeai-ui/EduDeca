/**
 * EduDeca individual-student welcome email (inline styles for clients).
 ...
 */
export const STUDENT_WELCOME_HTML_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
    ...
    <tr>
      <td align="center" style="padding:40px 16px;">
        <table role="presentation" class="container" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;background:#12161D;border-radius:18px;overflow:hidden;border:1px solid #232B36;">
          ...
          <!-- EduBlast logo (CDN asset; click-through stays on EduDeca) -->
          <tr>
